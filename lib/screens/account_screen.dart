...
class _AccountScreenState extends State<AccountScreen> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Edit Address', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800, color: Color(0xFF1A1A2E))),
              const SizedBox(height: 6),
              const Text('This address will be used for laundry pickups',
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  hintText: 'e.g. Plot 10, Kulambiro Road, Kampala',
                  hintStyle: const TextStyle(color: Color(0xFF9CA3AF)),
                  filled: true, fillColor: const Color(0xFFF9F8FF),
                  prefixIcon: const Icon(Icons.location_on_rounded, color: purple),
                  border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: Color(0xFFEDE9F6))),
                  enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: Color(0xFFEDE9F6))),
          ...
          child: Column(
            ...
            children: [
              Center(child: Container(width: 40, height: 4,
                  decoration: BoxDecoration(color: const Color(0xFFE5E7EB), borderRadius: BorderRadius.circular(2)))),
              const SizedBox(height: 20),
              const Text('Edit Phone Number', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w800, color: Color(0xFF1A1A2E))),
              const SizedBox(height: 16),
              TextFormField(
                controller: controller,
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: const TextStyle(color: Color(0xFF9CA3AF)),
                  filled: true, fillColor: const Color(0xFFF9F8FF),
                  prefixIcon: const Icon(Icons.phone_rounded, color: purple),
                  border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: Color(0xFFEDE9F6))),
                  enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: Color(0xFFEDE9F6))),
                  focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: const BorderSide(color: purple, width: 2)),
                ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('Save Phone', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700)),
                ),
              ),
              const SizedBox(height: 8),
            ],
  ...
  Future<void> _uploadPhoto() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        if (!mounted) return;
        setState(() => _user?['profile_photo_url'] = data['photo_url']);
  ...
  Future<void> _logout() async {
    final confirm = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const Text('Log Out', style: TextStyle(fontWeight: FontWeight.w800, color: Color(0xFF1A1A2E))),
        content: const Text('Are you sure you want to log out?', style: TextStyle(color: Color(0xFF6B7280), fontSize: 13)),
        actions: [
          TextButton(onPressed: () => Navigator.pop(context, false), child: const Text('Cancel', style: TextStyle(color: Color(0xFF6B7280)))),
          ElevatedButton(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(width: 140, height: 14, decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(7))),
                  ...
                  ...List.generate(3, (_) => Padding(
                    ...
                    child: Container(width: double.infinity, height: 64, decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(14))),
                  )),
                ],
              ),
            ),
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                                ...
                                child: GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border.all(color: const Color(0xFFEDE9F6), width: 1),
                                    ),
                                    child: const Icon(Icons.camera_alt_rounded, size: 14, color: purple),
                                  ),
                                ),
                              ),
                            ],
                          ...
                          Text(_user?['email'] ?? '',
                              style: const TextStyle(fontSize: 13, color: Color.fromRGBO(255, 255, 255, 0.75))),
                          const SizedBox(height: 8),
                          Container(
                            ...
                            child: Text(
                              ...
                              style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w700, color: Colors.white, letterSpacing: 1),
                            ),
                          ),
                        ],
                      ),
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _infoCard([
                            _infoRow(Icons.person_rounded, 'Full Name', _user?['name'] ?? '—'),
                            _divider(),
                            _infoRow(Icons.email_rounded, 'Email', _user?['email'] ?? '—'),
                            _divider(),
                            _editableRow(Icons.phone_rounded, 'Phone',
                                phone ?? 'Tap to add phone number', phone == null, onTap: _editPhone),
                          ]),
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: address == null ? const Color(0xFFFFFBEB) : Colors.white,
                                borderRadius: BorderRadius.circular(16),
                                border: Border.all(
                                  color: address == null ? const Color(0xFFFDE68A) : const Color(0xFFEDE9F6),
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    width: 44, height: 44,
                                    decoration: BoxDecoration(
                                      color: address == null ? const Color(0xFFFEF3C7) : lightPurple,
                                      borderRadius: BorderRadius.circular(12),
                                    ),
                                    child: Icon(Icons.location_on_rounded,
                                        color: address == null ? const Color(0xFFD97706) : purple, size: 22),
                                  ),
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          address == null ? 'No address added yet' : 'Pickup Address',
                                          style: TextStyle(
                                            fontSize: 11,
                                            color: address == null ? const Color(0xFFD97706) : const Color(0xFF9CA3AF),
                                            fontWeight: FontWeight.w600,
                                          ),
                                        ),
                                        const SizedBox(height: 2),
                                        Text(
                                          address ?? 'Tap here to add your pickup address',
                                          style: TextStyle(
                                            fontSize: 13, fontWeight: FontWeight.w600,
                                            color: address == null ? const Color(0xFF92400E) : const Color(0xFF1A1A2E),
                                          ),
                                        ),
                                      ],
                                    ),
                          ...
                          const SizedBox(height: 10),
                          _actionTile(icon: Icons.receipt_long_rounded, label: 'My Orders',
                              subtitle: 'View all your laundry orders',
                              onTap: () => Navigator.pushNamed(context, '/orders')),
                          const SizedBox(height: 10),
                          _actionTile(icon: Icons.notifications_rounded, label: 'Notifications',
                              subtitle: 'View your updates and alerts',
                              onTap: () => Navigator.pushNamed(context, '/notifications')),
                          const SizedBox(height: 10),
                          _actionTile(icon: Icons.calendar_month_rounded, label: 'Schedule Pickup',
                              ...
                              child: _loggingOut
                                  ...
                                  : const Row(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(width: 8),
                                        Text('Log Out', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 15)),
                                      ],
                                    ),
                            ),
                          ),
                          ...
                          const SizedBox(height: 12),
                          const Center(child: Text('Protos Laundries v1.0.0',
  ...
  Widget _infoCard(List<Widget> children) {
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: const Color.fromRGBO(0, 0, 0, 0.03), blurRadius: 8, offset: const Offset(0, 2))],
      ),
  ...
  Widget _editableRow(IconData icon, String label, String value, bool isEmpty, {required VoidCallback onTap}) {
            ...
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text(value, style: TextStyle(fontSize: 13, fontWeight: FontWeight.w600,
                    color: isEmpty ? const Color(0xFF9CA3AF) : const Color(0xFF1A1A2E))),
              ]),
            ),
  ...
  Widget _divider() => Container(height: 1, margin: const EdgeInsets.symmetric(horizontal: 16), color: const Color(0xFFF3F4F6));

  Widget _actionTile({required IconData icon, required String label, required String subtitle, required VoidCallback onTap}) {
    return GestureDetector(
      onTap: onTap,
      child: Container(
